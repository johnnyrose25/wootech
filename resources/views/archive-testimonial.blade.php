...
<body>
	<header x-data="{ isOpen: false }" class="bg-white border-b-4 border-gradient relative">
		<div class="container flex flex-wrap justify-between py-8">
			<a href="index.html" class="flex">
				<img src="assets/images/logo.svg" width="140" height="73" alt="Medical">
			</a>
  ...
  @endwhile
        ...
        <div class="relative">
			<img class="absolute inset-0 object-cover w-full h-full" src="assets/images/bg_get_in_touch.jpg" width="1920" height="250" alt="get in touch">
        ...
        <div class="container pt-10 pb-6 md:pt-14 md:pb-8">
			...
			<div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5 py-8">
				<div class="flex items-center justify-center lg:justify-start p-6 lg:pl-0 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="assets/images/partners/logo_swiss_visio.png" width="210" height="90" alt="swiss visio">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="assets/images/partners/logo_epfl.png" width="140" height="42" alt="EPFL">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="assets/images/partners/logo_canton_de_vaud.png" width="188" height="58" alt="canton de vaud">
				</div>
				<div class="flex items-center justify-center p-6 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="assets/images/partners/logo_fit.png" width="210" height="65" alt="fit">
				</div>
				<div class="flex items-center justify-center lg:justify-end p-6 lg:pr-0 grayscale hover:grayscale-0" data-aos="fade-up" data-aos-duration="1000">
					<img src="assets/images/partners/logo_schweizerische.png" width="251" height="63" alt="schweizerische">
				</div>
			</div>
		</div>
	</main><!-- /.main -->
	<footer class="footer bg-blue-100 bg-halftone text-white">
		...
		<div class="border-t border-white border-opacity-25">
			...
			<div class="flex items-center justify-center sm:justify-end">
					...
					<a href="#" target="_blank"><img src="assets/images/logo_hellenic-technologies.svg" width="114" height="53" alt="Hellenic Technologies"></a>
				</div>
			</div>
		</div>
	</footer><!--/.footer -->
